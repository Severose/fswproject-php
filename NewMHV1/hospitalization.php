...
// Query from database
	...
	while ($row7 = mysql_fetch_array($result7))
	{
		...
		$instance->diagnosis = $row7{'diagnosis'};// i changed now add reaadson
      ...
      <div class="navbar navbar-default container" role="navigation">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
			...
			echo "				<li class=\"current\"><a><span>Hospitalization</span></a></li>";
...
<div class = "container">
	...
	<?php  // hospitalization Insert button form	
echo"	<h3 class = \"text-primary\"> Add Hos </h3>";
   echo "<form  class =\"form-inline\" action=\"hosp_send.php\" method=\"POST\"> ";
   echo " <tr>";
  echo " <td><INPUT type=\"text\" name=\"date\" style=\"width:20%; margin: 7px; \" class=\"form-control\" autocomplete=\"on\" placeholder=\"Date\" required/></td>";
  echo " <td><INPUT type=\"text\" name=\"loc\" style=\"width:20%; margin: 7px; \" class=\"form-control\" autocomplete=\"on\" placeholder=\"Location\" required/></td>";
  echo " <td><INPUT type=\"text\" name=\"dur\" style=\"width:20%; margin: 7px; \" class=\"form-control\" autocomplete=\"on\" placeholder=\"Duration\" required/></td>";
  echo " <td><INPUT type=\"text\" name=\"reas\" style=\"width:20%; margin: 7px; \" class=\"form-control\" autocomplete=\"on\" placeholder=\"Reason\" required/></td>";
  echo " <td><INPUT type=\"text\" name=\"dis\" style=\"width:20%; margin: 7px; \" class=\"form-control\" autocomplete=\"on\" placeholder=\"Diagnosis\" required/></td>";
   echo " <td><INPUT type=\"text\" name=\"med\" style=\"width:20%; margin: 7px; \" class=\"form-control\" autocomplete=\"on\" placeholder=\"Changes\" required/></td>";
   echo " <td><INPUT type=\"text\" name=\"not\" style=\"width:50%; margin: 7px; margin-right: 15px;  \" class=\"form-control\" autocomplete=\"on\" placeholder=\"Note\" required/></td>";
